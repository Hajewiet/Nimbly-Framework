...
(function (root, factory) {
    ...
    function run(selector, userOptions) {
        ...
        return bind_onclick(selector, userOptions);
    }

    function bind_onclick(selector, userOptions) {
        ...
        [].forEach.call(galleryNodeList, function(galleryElement) {
            ...
            tagsNodeList = $(galleryElement).find('a');
