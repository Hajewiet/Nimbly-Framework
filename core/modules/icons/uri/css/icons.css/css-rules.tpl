...
@font-face { font-family: 'Glyphicons Halflings'; src: url('[base-url]/fonts/glyphiconshalflings-regular.eot');
    src: url('[base-url]/fonts/glyphiconshalflings-regular.eot?#iefix') format('embedded-opentype'),
    url('[base-url]/fonts/glyphiconshalflings-regular.woff') format('woff'),
    url('[base-url]/fonts/glyphiconshalflings-regular.ttf') format('truetype'),
    url('[base-url]/fonts/glyphiconshalflings-regular.svg#glyphicons_halflingsregular') format('svg'); }
 

.icon:before { font-family: 'Glyphicons Halflings';  font-style: normal;
